...
interface BudgetRepository {
    ...
    suspend fun loadBudgetByCategory(category: ExpenseCategory): Result<Budget?>
    suspend fun createBudget(category: ExpenseCategory, monthlyLimit: Double): Result<Budget>
