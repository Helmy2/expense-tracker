...
include(":feature:recurring-transactions:domain")
include(":feature:recurring-transactions:data")
include(":feature:recurring-transactions:api")
include(":feature:recurring-transactions:impl")
